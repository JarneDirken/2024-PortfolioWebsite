...
export const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      moreInfo: "For this project, we had to create a Flutter application in Dart that works on phones. We also needed to implement some sort of AR/VR to make use of the camera.<br><br>We created a fitness application where you can check all the exercises by muscle group. You can add, delete, and change muscle groups and exercises. We really paid attention to style the application professionally. For the AR part, we used the camera to scan an exercise in the fitness area, after which a video would appear showing how to do that exercise.<br><br> I grew the most in problem-solving, Figma, and being creative. I really enjoyed working on this project.",
    ...
    },
    {
      ...
      imgUrl: ReactNative,
      moreInfo: "I completed this project relatively quickly. The main idea behind starting a project in React Native was to improve my JavaScript skills as well as my knowledge of creating mobile applications.<br><br>I did learn quite a lot in the process of creating this app, and I am happy to share it with everyone.",
